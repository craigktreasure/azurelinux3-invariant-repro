...
docker build -f .\MyNewBlazoriseApp\Dockerfile --force-rm --build-arg baseImageTag=9.0-azurelinux3.0-distroless-extra-arm64v8@sha256:47100c385f5865ef1422114e84a75ad3b7942fda05e92ea4bd057e748d0bdd40 --build-arg sdkImageTag=9.0-azurelinux3.0 --build-arg TFM=net9.0 -t mynewblazoriseapp:net9-azurelinux3 .
if ($LASTEXITCODE -ne 0) {
    Write-Error 'Container build failed.'
}
